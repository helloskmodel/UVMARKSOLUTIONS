    ...
    <>
      <section className="hero">
        ...
        <div className="heroContent">
          <p className="eyebrow">
            Modern Biotech Workflow Support
          </p>

          <h1>
            Flexible Labeling Solutions for Fast-Moving
            Laboratories and Clinical Research
          </h1>

          <p className="slogan">
            Agile labeling and identification support
          ...
          {whyCards.map((card) => {
            ...
            return (
              <article
                ...
                key={typeof card.title === "string" ? card.title : "quick-response"}
              >
      ...
      <section className="contact">
        <div className="contactCard">
          ...
          <p>
            Tell us what you need. We’ll help build
            the right labeling solution around your workflow.
          </p>
