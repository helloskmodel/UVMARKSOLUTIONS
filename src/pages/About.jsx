    ...
    <main className="about-page">
      <section className="about-hero">
        ...
        <p className="about-intro">
          UVMARK provides durable labels and integrated identification solutions
          designed for biopharmaceutical research, clinical diagnostics, and
          demanding laboratory workflows.
        </p>
      </section>
